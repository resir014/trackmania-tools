  ...
  (
    ...
    <a
      className={clsx(
        ...
        'items-center justify-center border border-transparent font-medium text-blue-200 hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500',
        disabledStyles,
        className
      )}
      ref={ref}

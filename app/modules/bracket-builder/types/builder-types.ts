import {
  ...
  type PreviousRoundParticipant,
  type QualifierParticipant,
  type SeedParticipant,
  type TeamPreviousRoundParticipant,
  type TeamSeedParticipant,
...
export interface BracketStore {
  ...
  updateMatchSpotDetails: (index: number, matchIndex: number, spotIndex: number, detail: AllParticipant) => void;
}

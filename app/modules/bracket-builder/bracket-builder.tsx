import { ArrowDownTrayIcon, ArrowUpTrayIcon, InformationCircleIcon, TrashIcon } from '@heroicons/react/24/outline';
...
export default function BracketBuilderModule() {
  ...
  return (
    <>
      <PageContent className="sm:py-12">
        <div className="container mx-auto space-y-8">
          <PageHeader
            ...
            actions={
              <div className="-m-2 flex flex-wrap items-center">
                <PrimaryButton className="m-2" icon={ArrowDownTrayIcon} color="blue" onClick={openExportModal}>
                  Export
                </PrimaryButton>
                <PrimaryButton className="m-2" icon={ArrowUpTrayIcon} color="blue" onClick={openImportModal}>
                  Import
                </PrimaryButton>
                <PrimaryButton className="m-2" icon={TrashIcon} color="red" onClick={handleConfirmClear}>
                  Clear
                </PrimaryButton>
              </div>
            }
          ...
          <SimpleBar className="xl:h-[739px]" forceVisible="x" autoHide={false}>
            <div className="relative flex flex-col gap-6 xl:h-full xl:w-full xl:flex-row xl:pt-7 xl:pb-14">
      ...
      <ExporterDrawer isOpen={isExportModalOpen} generatedJSON={generatedJSON} onClose={closeExportModal} />
      <ImporterDrawer

...
export default function AboutModal({ isOpen, onClose }: AboutModalProps) {
  ...
  return (
    <Transition.Root show={isOpen} as={React.Fragment}>
      <Dialog as="div" className="relative z-10" initialFocus={closeButtonRef} onClose={handleCloseDialog}>
        <Transition.Child
          as={React.Fragment}
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-gray-900 px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                <div className="sm:flex sm:items-start">
                  <div className="bg-opacity-50 mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-gray-500 sm:mx-0 sm:h-10 sm:w-10">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2 space-y-3">
                      ...
                      <h4 className="text-md leading-6 font-medium text-white">Special Thanks</h4>
                      <ul>
                ...
                <div className="mt-5 sm:mt-4 sm:ml-10 sm:flex sm:pl-4">
                  <OutlineButton type="button" color="gray" onClick={handleCloseDialog} ref={closeButtonRef}>
                    Close
                  </OutlineButton>
                </div>
              </Dialog.Panel>

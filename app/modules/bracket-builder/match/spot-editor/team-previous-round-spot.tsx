...
import { type TeamPreviousRoundParticipant } from '../../types/participant-types';
...
export interface TeamPreviousRoundSpotProps {
  spot: TeamPreviousRoundParticipant;
  onChange?: (spot: TeamPreviousRoundParticipant) => void;
}

export function TeamPreviousRoundSpot({ spot, onChange }: TeamPreviousRoundSpotProps) {

...
export const ConfirmDialogContext = React.createContext<ConfirmDialogContextObject>({} as ConfirmDialogContextObject);
...
export function ConfirmDialogProvider({ children }: React.PropsWithChildren) {
  ...
  const [dialogOptions, setDialogOptions] = React.useState<ConfirmDialogOptions | undefined>(undefined);

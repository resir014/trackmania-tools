  ...
  (
    ...
    <button
      className={clsx(
        ...
        'items-center justify-center border border-transparent font-medium shadow-sm ring-offset-gray-900 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:outline-none',

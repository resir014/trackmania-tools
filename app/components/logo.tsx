...
export function TMToolsLogo({ height = 32, color = '#fff', ...props }: TMToolsLogoProps) {
  return (
    <svg height={height} viewBox="0 0 100 32" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <defs>
        ...
        <linearGradient id="paint1_linear_1977_30" x1={33} y1={16} x2={65} y2={16} gradientUnits="userSpaceOnUse">
          <stop stopColor={color} />
          <stop offset={1} stopColor={color} stopOpacity={0} />
        </linearGradient>
        <linearGradient id="paint2_linear_1977_30" x1={67} y1={16} x2={99} y2={16} gradientUnits="userSpaceOnUse">
          <stop stopColor={color} />
          <stop offset={1} stopColor={color} stopOpacity={0} />
        </linearGradient>
      </defs>
